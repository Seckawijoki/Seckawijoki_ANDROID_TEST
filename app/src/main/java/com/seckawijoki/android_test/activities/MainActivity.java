...
import com.seckawijoki.android_test.fragments.MainFragment;
...
public class MainActivity extends AppCompatActivity {
  ...
  public void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    if (fragment == null){
      ...
      ActivityUtils.addFragmentToActivity(getSupportFragmentManager(), fragment, R.id.layout_main_fragment);
    }
  }
}
