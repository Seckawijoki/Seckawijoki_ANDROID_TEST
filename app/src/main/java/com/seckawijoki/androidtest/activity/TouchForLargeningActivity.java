...
import com.seckawijoki.androidtest.adapter.TouchForLargeningAdapter;
import com.seckawijoki.androidtest.R;
import com.seckawijoki.androidtest.listener.TouchForLargeningListener;
  ...
  public void onClick(View v) {
    switch (v.getId()){
      case R.id.btn_first_touch:
        ToastUtil.makeText(this, "first click");
        break;
      case R.id.btn_second_touch:
        ToastUtil.makeText(this, "second click");
        break;
    }
  }
}
