  ...
  private void dataBindingNotificationTest() {
    ...
    Observable.OnPropertyChangedCallback onPropertyChangedCallback = new Observable.OnPropertyChangedCallback() {
      ...
      public void onPropertyChanged(Observable sender, int propertyId) {
        if ( propertyId == com.seckawijoki.androidtest.BR.name ) {
          Log.i(TAG, "BR.name");
        } else if ( propertyId == com.seckawijoki.androidtest.BR.details ) {
          Log.i(TAG, "BR.details");
        } else if ( propertyId == com.seckawijoki.androidtest.BR._all ) {
          Log.i(TAG, "BR._all");
        } else {
          Log.e(TAG, "未知");
        }
